...
This is a **Kotlin-based Model Context Protocol (MCP) server** using the official `kotlin-sdk`. It is designed to expose tools (like `greet`) over streaming HTTP for integration with MCP clients.
