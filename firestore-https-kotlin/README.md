...
```json
{
  "mcpServers": {
    "kotlin-hello-world": {
      "command": "java",
      "args": ["-jar", "/path/to/firestore-https-kotlin/build/libs/firestore-https-kotlin-1.0-SNAPSHOT.jar"]
    }
  }
}
```

*Note: Ensure the absolute path is correct. The standard build produces `firestore-https-kotlin-1.0-SNAPSHOT.jar`.*
